...
export const socketManager = new LazySingleton(() => new SocketManager({}))
    .lazyInstance;
export const clientManager = new LazySingleton(
    () => new ClientManager(socketManager),
).lazyInstance;
export const robotManager = new LazySingleton(
    () =>
        new RobotManager(
            USE_VIRTUAL_ROBOTS ?
